        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <h2 class="intro-x font-bold text-2xl xl:text-3xl text-center xl:text-left">{!! __('login.reset_password') !!}</h2>
                    <div
                    ...
                    <div class="intro-x mt-8">
                        <form action="" method="POST">
                            ...
                            <input name="email" id="email" type="text"
                                   ...
                                   placeholder="{{ __('login.email') }}" value="{{ request('email') }}">
                            ...
                            <input name="password_confirmation" id="password_confirmation" type="password"
                                   class="intro-x login__input form-control py-3 px-4 block mt-4 @error('password_confirmation') border-danger @enderror"
