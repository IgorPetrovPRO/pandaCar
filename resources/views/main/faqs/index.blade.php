...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('faqs.create')}}" class="btn btn-primary shadow-md mr-2">{{ __('faqs.add') }}</a>
            ...
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                ...
                <table class="table table-report -mt-2">
                    ...
                    <tr>
                        ...
                        <th class="text-center whitespace-nowrap">{{ __('faqs.table_th_products') }}</th>
                        <th class="text-center whitespace-nowrap">{{ __('faqs.table_th_status') }}</th>
